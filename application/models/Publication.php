<?php
    class Publication extends MY_Model{
        ...
        public function insert($id_publication, $id_client, $id_location,$titre,$description, $prix,$latitude,$longitude,$nbr_piece,$surface){
            $sql="INSERT INTO Publication(id_publication, id_client,id_location,titre,description,prix,lieu,date_publication,latitude,longitude, nbr_piece,surface) values(%s, %s, %s, %s, %s, %s,NOW(),%s,%s,%s,%s)";
