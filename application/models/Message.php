<?php 
    class Message extends MY_Model{
        ...
        function get_messages($idClient1, $idClient2,$id_pub){
            $condition = "idpublication = $id_pub and (id_client_sender=$idClient1 or id_client_receiver=$idClient2) and (id_client_sender=$idClient2 or id_client_receiver=$idClient1)";
