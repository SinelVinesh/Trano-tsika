            ...
            <div class="modal-body">
                <div class="container">
                    <form action="<?= site_url('AjoutPublicationController/ajout_publication') ?>" method="post"
                        ...
                        <div class="utilities">
                            ...
                            <div class="utilities-checks">
                                <div class="form-check">
                                    <input class="form-check-input" name="tagsUtil[]" type="checkbox" value="2"
                                           id="courant">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" name="tagsUtil[]" type="checkbox" value="1"
                                           id="Eau">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" name="tagsUtil[]" type="checkbox" value="3"
                                           id="Meuble">
                        ...
                        <div class="utilities">
                            <label>Liez votre maison avec google map <a data-target="#link-map" data-toggle="modal"><u
                                            class="link-map">Link to google map</u></a></label>
                        </div>
                            ...
                            <div class="utilities-checks">
                                <div class="row p-0 m-0">
                                    <div class="col-md-3 p-0 m-0">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" name="tags[]" type="checkbox" value="2"
                                                   id="Yard">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" name="tags[]" type="checkbox" value="3"
                                                   id="For_students">
                                    ...
                                    <div class="col-md-3 p-0 m-0">
                                        <div class="form-check">
                                            <input class="form-check-input" name="tags[]" type="checkbox" value="4"
                                                   id="Foreground">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" name="tags[]" type="checkbox" value="5"
                                                   id="Restroom_indoor">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" name="tags[]" type="checkbox" value="6"
                                                   id="Garage">
                        ...
                        <input type="file" name="images[]" class="custom-file-input" id="file-input" accept="image/*"
...
<!-- boost advantage -->
<div class="modal fade" id="boost-advantage" tabindex="-1" role="dialog" aria-labelledby="boost-advantageTitle"
     aria-hidden="true">
                            ...
                            <div class="advantage-list p-4 border-bottom">
                                ...
                                <div class="one-disadvantage pb-2">
                                    <i class="fa-solid fa-xmark"></i> <span
                                            class="ml-2">Augmentation des suggestions</span>
                                </div>
                            ...
                            <div class="advantage-list p-4 border-bottom">
                                ...
                                <div class="pricing pb-2">
                                    <i class="fa-solid fa-money-bill-1"></i> <span
                                            class="ml-2">10,000.0 ar / semaine</span>
                                </div>
                            </div>
                            <div class="decision pl-4 pt-3">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header search-container">
                ...
                <button type="button" class="btn btn-light add-bg rounded-circle" data-dismiss="modal"
                        aria-label="Close">
                    <i class="fa-solid fa-xmark"></i>
                </button>
            </div>
            <div class="modal-body">
                <span class="multi-text">Multicriteria <i class="fa-solid fa-caret-down" id="caret-down"></i> <i
                            class="fa-solid fa-caret-up" id="caret-left"></i></span>
