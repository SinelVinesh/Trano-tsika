...
<head>
    ...
    <link rel="stylesheet" href="custom-assets/css/survey.css">
    <link rel="stylesheet" href="custom-assets/css/boost.css">
            ...
            <div class="col-12 col-md-6 col-xl-4">
                <a href="" class="pub-link" title="Voir details" >
                    <div class="single-featured-property mb-50 wow fadeInUp" data-wow-delay="200ms">
                        <!-- Property Thumbnail -->
                        <div class="property-thumb">
                            <img src="assets/bg-img/feature2.jpg" alt="">
            ...
            <div class="col-12 col-md-6 col-xl-4">
                <a href="" class="pub-link" title="Voir details" >
                    <div class="single-featured-property mb-50 wow fadeInUp" data-wow-delay="300ms">
                        <!-- Property Thumbnail -->
                        <div class="property-thumb">
                            <img src="assets/bg-img/feature3.jpg" alt="">
            ...
            <div class="col-12 col-md-6 col-xl-4">
                <a href="" class="pub-link" title="Voir details" >
                    <div class="single-featured-property mb-50 wow fadeInUp" data-wow-delay="400ms">
                        <!-- Property Thumbnail -->
                        <div class="property-thumb">
                            <img src="assets/bg-img/feature4.jpg" alt="">
            ...
            <div class="col-12 col-md-6 col-xl-4">
                <a href="" class="pub-link" title="Voir details" >
                    <div class="single-featured-property mb-50 wow fadeInUp" data-wow-delay="500ms">
                        <!-- Property Thumbnail -->
                        <div class="property-thumb">
                            <img src="assets/bg-img/feature5.jpg" alt="">
            ...
            <div class="col-12 col-md-6 col-xl-4">
                <a href="" class="pub-link" title="Voir details" >
                    <div class="single-featured-property mb-50 wow fadeInUp" data-wow-delay="600ms">
                        <!-- Property Thumbnail -->
                        <div class="property-thumb">
                            <img src="assets/bg-img/feature6.jpg" alt="">
        ...
        <div class="modal-content">
            ...
            <form>
                ...
                <div class="modal-footer d-flex justify-content-between">
                    ...
                    <button class="btn btn-outline-secondary rounded-0 next" type="submit"><span><i>Valider</i></span></button>
                    ...
                    <div class="col-md-5 col-sm-6">
                        <div class="boost-box w-100 m-1 pb-3 border mb-3">
                            ...
                            <div class="decision pl-4 pt-3">
                                <button class="btn btn-outline-dark w-20 rounded-0 " id="publish-free">Publish free</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-5 col-sm-6">
                        <div class="boost-box w-100 m-1 pb-3 border mb-3">
                            ...
                            <div class="decision pl-4 pt-3">
                                <button class="btn btn-success w-20 rounded-0" id="publish-boost">Publish & Boost</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<style>
    ...
    input.search-title:focus, input.search-title:hover {
...
<div class="modal fade" id="searchModal" tabindex="-1" role="dialog" aria-labelledby="searchModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <span class="multi-text">Multicriteria <i class="fa-solid fa-caret-down" id="caret-down" ></i> <i class="fa-solid fa-caret-right" id="caret-left"></i></span>
...
<script src="custom-assets/js/survey.js" ></script>
<script src="custom-assets/js/boost.js" ></script>
